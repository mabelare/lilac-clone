        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-8 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <p className="mt-6 text-lg sm:text-xl lg:text-3xl leading-relaxed">
              Compassionate therapy in Santa Monica for anxiety, trauma, and
              chronic stress.
            </p>
            ...
            >
              Schedule a Consultation <span aria-hidden="true">&rarr;</span>
            </button>
          </div>
        </div>
      </section>
        ...
        <div className="bg-primary text-secondary w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
          <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-16">
            <div className="w-full lg:w-1/2 px-6 py-4 lg:px-0 lg:py-16">
              <h2 className="text-3xl sm:text-4xl lg:text-6xl font-semibold text-secondary">
                WHO I HELP
              </h2>
