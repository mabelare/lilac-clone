...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-secondary text-primary">
      <header className="sticky top-0 z-40 flex items-center justify-between px-6 py-4 bg-white">
        <button
      ...
      <div className="mt-12 bg-primary text-white w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
        <div className="max-w-4xl mx-auto border border-primary p-8 sm:p-12 lg:max-w-6xl lg:border-0 lg:px-14 lg:py-16 lg:grid lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-20">
          <div>
            <h2 className="text-3xl sm:text-4xl font-semibold text-white mb-8 lg:text-6xl lg:mb-8">
              Our Office
            </h2>
      ...
      <div className="bg-secondary text-primary py-12 px-6">
      ...
      <footer className="m-0 p-0 bg-secondary text-primary">
        ...
        <div className="border-t border-primary bg-primary text-secondary w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
          <div className="px-6 pt-8 pb-0 text-center text-sm sm:text-base">
